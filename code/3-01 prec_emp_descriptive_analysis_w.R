...
# change to numeric
dfas1a_end$sf12pcs_dv <- as.numeric(dfas1a_end$sf12pcs_dv,  na.rm = FALSE)
dfas1a_end$sf12mcs_dv <- as.numeric(dfas1a_end$sf12mcs_dv,  na.rm = FALSE)
...
dfas1b_end$sf12mcs_dv <- as.numeric(dfas1b_end$sf12mcs_dv,  na.rm = FALSE)
...
tab_vars <- c("sex_dv", "age_dv", "emp_contract", "broken_emp", "j2has", 
              "srh_dv", "ghq_case4", "sf12pcs_dv", "sf12mcs_dv")

tableone_a <- tableone::svyCreateTableOne(vars = tab_vars, 
                            data = svy_dfas1a_end,
                            includeNA = TRUE)

tableone_b <- tableone::svyCreateTableOne(vars = tab_vars, 
                                        data = svy_dfas1b_end,
                                        includeNA = TRUE)
