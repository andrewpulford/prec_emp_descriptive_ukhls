...
# 2-02 - ungrouped sequence analysis - unweighted
# Andrew Pulford
...
write_rds(dfas1a_seq_wide2, "./working_data/dfas1a_seq_wide2.rds")
...
write_rds(dfas1b_seq_wide2, "./working_data/dfas1b_seq_wide2.rds")
...
write_rds(dfas1a_seq_wide3, "./working_data/dfas1a_seq_wide3.rds")
...
write_rds(dfas1b_seq_wide3, "./working_data/dfas1b_seq_wide3.rds")
...
####save wide sequence dfs and seuquece dfs

saveRDS(dfas1a_seq_wide, "./working_data/dfas1a_seq_wide.rds")
saveRDS(dfas1b_seq_wide, "./working_data/dfas1b_seq_wide.rds")

saveRDS(emp_contract.seq.a, "./working_data/emp_contract.seq.a.rds")
saveRDS(emp_contract.seq.b, "./working_data/emp_contract.seq.b.rds")

saveRDS(broken_emp.seq.a, "./working_data/broken_emp.seq.a.rds")
saveRDS(broken_emp.seq.b, "./working_data/broken_emp.seq.b.rds")

saveRDS(multi_jobs.seq.a, "./working_data/multi_jobs.seq.a.rds")
saveRDS(multi_jobs.seq.b, "./working_data/multi_jobs.seq.b.rds")
