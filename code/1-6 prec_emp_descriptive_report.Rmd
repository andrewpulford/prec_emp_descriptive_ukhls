...
empcontract_fit_stats <- read.csv("../output/descriptive/empcontract_fit_stats.csv")
kable(empcontract_fit_stats)
image_read("../output/descriptive/empcontract_lca_elbow.tiff")
```

#### Sample A - five class model
```{r, echo=FALSE}
readRDS("../output/descriptive/empcontract_lca5.rds")

image_read("../output/descriptive/empcontract_lca5.tiff")
```
