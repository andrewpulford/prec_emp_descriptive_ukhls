...
Latent class analysis of employment contract across study period B provided a very similar solution to that modelled for study period A, with a five class solution presenting as the optimum solution (Table x, Figure x, Figure x).
...
```
Latent class analysis of multiple employment across study period A provided a very similar solution to that modelled for employment contract, with a five class model presenting as the optimum solution (Table x, Figure x, Figure x). 
...
Individuals who reported multiple employment for most or all the study waves represented `r prettyNum(multi_a_pc)`% of Sample A.

**Figure x: Multiple employment sequences ascending in order of frequency grouped by latent class membership - Sample A **
...
**Figure x: Multiple employment sequences ascending in order of frequency grouped by latent class membership - Sample B **
...
**Figure 2: Number of waves responded to by percentage of the analytic sample  (unweighted)**
...
\newpage
## Sequence analysis of precarious employment exposures of interest
**Figure 3: Valid response sequences ascending in order of frequency  (unweighted)**
...
## Latent class analaysis - Employment contract
### Employment contract - Sample A
**Table 2: Model fit statistics for employment contract latent class analysis solutions (2-8 classes) - Sample A **
...
**Figure 7: BIC elbow plot for employment contract latent class analysis solutions (2-8 classes) - Sample A **
...
**Figure 8: Employment contract latent class membership for five class model - Sample A **
...
**Table x: Model fit statistics for employment contract latent class analysis solutions (2-8 classes) - Sample B** 
```{r, echo=FALSE}
kable(empcontractb_fit_stats)
```

**Figure x: BIC elbow plot for employment contract latent class analysis solutions (2-8 classes) - Sample B**
```{r, echo=FALSE}
...
**Figure x: Employment contract latent class membership for five class model - Sample B  **
...
## Latent class analaysis - Mutiple employment
### Mutiple employment - Sample A
**Table x: Model fit statistics for multiple employment latent class analysis solutions (2-8 classes) - Sample A **
...
**Figure x: BIC elbow plot for multiple employment latent class analysis solutions (2-8 classes) - Sample A **
...
**Figure x: Multiple employment latent class membership for five class model - Sample A **
...
\newpage
### Mutiple employment - Sample B
**Table x: Model fit statistics for multiple employment latent class analysis solutions (2-8 classes) - Sample B **
...
**Figure x: BIC elbow plot for multiple employment latent class analysis solutions (2-8 classes) - Sample B **
...
**Figure x: Multiple employment latent class membership for five class model - Sample B **
